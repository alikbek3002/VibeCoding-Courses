...
interface PricingCardProps {
  ...
  className?: string
  // optional integration props (backward compatible):
  highlight?: boolean // visually feature this tier + filled CTA
  href?: string // make the CTA a link (e.g. WhatsApp) instead of a plain button
}
...
export const PricingCard = ({
  ...
  const featured = highlight || tier === "Pro"
  return (
    <motion.div
    ...
    >
      ...
      >
        ...
        {href ? (
          ...
          <Button className="w-full" variant={featured ? "default" : "ghost"}>
            {CTA}
          </Button>
        )}
      </Card>
